...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep punctuation attached to the sentence.  The fallback at the end
        # also handles headings/list items that do not end in punctuation.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Reattach separators so splitting does not silently change the source
        # text.  Whitespace at outer chunk boundaries is normalized below.
        parts = [
